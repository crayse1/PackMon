...
Imports System.Data
Imports System.Net
Imports v2Softwares.Network.PackMon
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'MainMenu
        '
        Me.MainMenu.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.FileMenu, Me.HelpMenu})
        '
        'HelpMenu
        '
        Me.HelpMenu.Index = 1
...
#End Region
    ...
    Public Sub OnToolBarClick(ByVal sender As Object, ByVal e As ToolBarButtonClickEventArgs) Handles ToolBar.ButtonClick
        ...
        ElseIf e.Button Is AboutButton Then
            MsgBox("Sniffer.NET powered by PackMon.NET Library", MsgBoxStyle.Information)
        End If
    End Sub
    ...
    Public Sub OnPacketDoubleClick(ByVal sender As Object, ByVal e As EventArgs) Handles PacketList.DoubleClick
        ...
        If l.SelectedItems.Count > 0 Then
            Dim pf As PacketForm = New PacketForm(m_Packets(l.SelectedItems(0).Index))
            pf.Show()
        End If
    End Sub
